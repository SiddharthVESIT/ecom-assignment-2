...
const footerLinks = [
  {
    ...
    links: [
      ...
      { label: 'Running', path: '/products?category=Running' },
      { label: 'Casual', path: '/products?category=Casual' },
      { label: 'Formal', path: '/products?category=Formal' },
      ...
      <div className="max-w-[1280px] mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="mt-4 text-[var(--color-text-secondary)] text-sm leading-relaxed">
              Premium footwear for those who dare to stand out. Every step is a statement.
            </p>
          ...
          {footerLinks.map(section => (
            <div key={section.title}>
              <h4 className="font-[family-name:var(--font-display)] text-lg tracking-wider text-white mb-4">
                {section.title}
              </h4>
        ...
        <div className="mt-16 pt-8 border-t border-[var(--color-border)] flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-[var(--color-text-secondary)]">
            © 2025 StepUp Shoes. College Assignment Frontend Demo.
          </p>
          <p className="text-xs text-[var(--color-text-secondary)]">
