        ...
        <div className="relative bg-[var(--color-surface)] rounded-xl overflow-hidden product-card-hover border border-[var(--color-border)]">
          ...
          <div className="relative aspect-square overflow-hidden">
            ...
            >
              <Heart
                size={16}
                className={`transition-colors ${liked ? 'fill-[var(--color-accent)] text-[var(--color-accent)]' : 'text-white'}`}
              />
            </button>
            ...
            <div className="absolute inset-x-0 bottom-0 p-4 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
              <button
                ...
                className="w-full py-3 bg-[var(--color-accent)] text-white font-semibold text-sm rounded-lg flex items-center justify-center gap-2 hover:bg-[var(--color-accent-soft)] transition-colors"
              >
                <ShoppingBag size={16} />
                Add to Cart
              </button>
