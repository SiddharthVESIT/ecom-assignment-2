    ...
    <main className="pt-24 pb-20 px-6 min-h-screen flex items-center justify-center">
      ...
      >
        <div className="text-center mb-8">
          <h1 className="font-[family-name:var(--font-display)] text-4xl text-white tracking-wide">
            WELCOME <span className="gradient-text">BACK</span>
          </h1>
          <p className="text-[var(--color-text-secondary)] mt-2">Sign in to your StepUp account</p>
        </div>
        ...
        >
          ...
          <div className="mb-6 p-4 rounded-xl bg-[var(--color-accent)]/5 border border-[var(--color-accent)]/20">
            ...
            <p className="text-xs text-[var(--color-text-secondary)]">
              Email: <span className="text-white">user@stepup.com</span>
            </p>
            <p className="text-xs text-[var(--color-text-secondary)]">
              Password: <span className="text-white">demo1234</span>
            </p>
            <button
              onClick={quickFill}
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="py-3 border border-[var(--color-border)] rounded-lg text-sm text-white font-medium hover:bg-[var(--color-border)] transition-colors">
              Google
            </button>
            <button className="py-3 border border-[var(--color-border)] rounded-lg text-sm text-white font-medium hover:bg-[var(--color-border)] transition-colors">
              Apple
