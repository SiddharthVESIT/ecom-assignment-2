      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="flex gap-8">
          ...
          <button
            ...
            className="lg:hidden fixed bottom-6 right-6 z-40 w-14 h-14 bg-[var(--color-accent)] text-[var(--color-text-primary)] rounded-full flex items-center justify-center shadow-lg"
          >
            ...
            <div className="lg:hidden fixed inset-0 z-50 bg-black/80 flex justify-end">
              ...
              >
                <div className="flex justify-between items-center mb-6">
                  <h3 className="text-[var(--color-text-primary)] font-semibold text-lg">Filters</h3>
          ...
          <div className="flex-1">
            ...
            {filtered.length === 0 && (
              <div className="text-center py-20">
                <p className="text-[var(--color-text-secondary)] text-lg">No properties match your filters.</p>
              </div>
            )}
          </div>
        </div>
...
function FilterPanel({ selectedCategory, setSelectedCategory, selectedPrice, setSelectedPrice, sortBy, setSortBy }) {
  return (
    <div className="space-y-8">
      {/* Category */}
      <div>
        <h4 className="text-[var(--color-text-primary)] font-semibold text-sm uppercase tracking-wider mb-4">Category</h4>
      ...
      {/* Price Range */}
      <div>
        <h4 className="text-[var(--color-text-primary)] font-semibold text-sm uppercase tracking-wider mb-4">Price Range</h4>
        <div className="space-y-2">
      ...
      {/* Sort */}
      <div>
        <h4 className="text-[var(--color-text-primary)] font-semibold text-sm uppercase tracking-wider mb-4">Sort By</h4>
        <select
          value={sortBy}
          onChange={e => setSortBy(e.target.value)}
          className="w-full px-4 py-2.5 bg-[var(--color-border)] text-[var(--color-text-primary)] rounded-lg text-sm border-none outline-none"
        >
