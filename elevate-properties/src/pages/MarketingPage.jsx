...
const personas = [
  {
    ...
    type: 'HNI Investor',
    budget: '₹5Cr – ₹20Cr',
    channel: 'Instagram Reels / LinkedIn',
    emoji: '✈️',
    description: 'High Net Worth Individual looking for high-yield luxury real estate in prime locations back home. Wants property management included.',
    behaviors: ['Follows luxury real estate pages on Instagram', 'Relies on trusted broker advice', 'Invests for capital appreciation', 'Values brand reputation']
  },
  {
    ...
    budget: '₹1Cr – ₹3Cr',
    channel: 'Google Search / Instagram',
    emoji: '💼',
    description: 'Tech executive looking for a secured gated community with modern amenities. Wants a hassle-free buying experience with legal safety.',
    behaviors: ['Reads RERA approvals thoroughly', 'Takes virtual tours via Instagram Ads', 'Looks for ready-to-move options', 'Values proximity to tech parks']
  },
  {
    name: 'Business Rahul',
    age: '40–55',
    ...
    budget: '₹10Cr – ₹50Cr',
    channel: 'Direct Network',
    emoji: '🏢',
    description: 'Business owner looking to expand office spaces or invest in retail for rental returns. Seeks high footfall locations and Grade A buildings.',
    behaviors: ['Leverages broker networks', 'Checks commercial yields', 'Prefers long-term leases', 'Values premium commercial addresses']
  }
];
      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        >
          ...
          <p className="text-[var(--color-text-secondary)] mt-4 max-w-2xl mx-auto text-lg">
            Our multi-channel approach to reach, engage, and match luxury properties with elite buyers
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
          {personas.map((persona, i) => (
            ...
            >
              ...
              <h3 className="text-[var(--color-text-primary)] font-bold text-xl mb-1">{persona.name}</h3>
              ...
              <div className="mt-4 flex items-center gap-2">
                ...
                <span className="text-xs text-[var(--color-text-secondary)]">
                  Primary Channel: <span className="text-[var(--color-text-primary)]">{persona.channel}</span>
                </span>
              </div>
            </motion.div>
          ))}
              ...
              >
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-2">
                    <h4 className="text-[var(--color-text-primary)] font-semibold">{channel.name}</h4>
        ...
        >
          ...
          <h3 className="font-[family-name:var(--font-display)] text-3xl text-[var(--color-text-primary)] tracking-wide mb-4">
            BRAND VOICE
          </h3>
          ...
          <p className="text-[var(--color-text-secondary)] max-w-2xl mx-auto leading-relaxed">
            Elevate Estates speaks to the modern Indian investor — aspirational but secure. We celebrate structural elegance,
            not just addresses. Our tone is bold, confident, and professional. We inspire wealth creation and luxury living.
          </p>
        </motion.div>
        ...
        >
          <img
            src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=1400&h=500&fit=crop&q=80"
            alt="Elevate Estates Instagram Campaign"
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent flex flex-col items-center justify-end p-12">
            ...
            <span className="text-xs text-[var(--color-accent)] uppercase tracking-widest mb-2">Instagram Exclusive Campaign</span>
            <h3 className="font-[family-name:var(--font-display)] text-4xl md:text-5xl text-white text-center">
              "BEYOND WALLS"
            </h3>
            <p className="text-zinc-300 text-center mt-3 max-w-lg">
              High-production cinematic drone tours and lifestyle snippets on Instagram Reels targeted directly to HNI audiences. Showcasing exactly what it feels like to live in an Elevate property.
            </p>
          </div>
        </motion.div>
      </div>
